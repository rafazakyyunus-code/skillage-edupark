...
import programData from "../program/Programdata";   // ← sesuaikan path jika perlu
import { MessageCircle, Leaf } from 'lucide-react';

// Ambil heroImage dari sumber terpusat
const { heroImage } = programData.find(p => p.key === "venue-alam");
...
export default function VenueAlam() {
  ...
  return (
    <div className="venue-page">
      {/* heroImage sekarang dari programData — sama dengan yang di ProgramSection */}
