  ...
  return (
    <section className="gallery" ref={sectionRef}>
      ...
      {!loading && photos.length === 0 && (
        <div className="gallery-empty" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          {/* Icon: Image/Gallery Outline */}
          <svg 
            ...
            style={{ width: '48px', height: '48px', color: '#9ca3af', marginBottom: '12px' }}
          >
